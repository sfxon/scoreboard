...
// Continue integration here:
    ...
    // Make some overlay -> whenever you move the mouse over the scoreboard, buttons should be shown that can change values interactively. Add an option, so that this is always possible -> call it "Touch screen mode".
    ...
    // Add info-bar, that this is a local game, not a live game.